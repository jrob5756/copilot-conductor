...
### New Files
- `src/copilot_conductor/engine/cache.py` - CacheStore and implementations
- `src/copilot_conductor/cli/cache.py` - CLI commands
- `tests/test_engine/test_cache.py` - Unit tests

### Modified Files
- `src/copilot_conductor/config/schema.py` - Add CacheConfig
- `src/copilot_conductor/executor/agent.py` - Integrate caching
- `src/copilot_conductor/engine/workflow.py` - Initialize cache store
- `src/copilot_conductor/cli/app.py` - Add cache commands
- `src/copilot_conductor/cli/run.py` - Add --no-cache flag
- `src/copilot_conductor/providers/base.py` - Add from_cache field to AgentOutput
