...
### New Files
- `src/copilot_conductor/engine/pricing.py` - Pricing tables and cost calculation
- `src/copilot_conductor/engine/usage.py` - Usage tracking
- `tests/test_engine/test_usage.py` - Unit tests

### Modified Files
- `src/copilot_conductor/providers/base.py` - Enhance AgentOutput
- `src/copilot_conductor/providers/copilot.py` - Populate token fields
- `src/copilot_conductor/providers/claude.py` - Populate token fields (when implemented)
- `src/copilot_conductor/config/schema.py` - Add CostConfig
- `src/copilot_conductor/engine/workflow.py` - Integrate usage tracking
- `src/copilot_conductor/cli/run.py` - Display cost summary
