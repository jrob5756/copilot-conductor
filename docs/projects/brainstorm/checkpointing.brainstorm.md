...
### New Files
- `src/copilot_conductor/engine/checkpoint.py` - CheckpointStore and implementations
- `src/copilot_conductor/cli/checkpoints.py` - CLI commands
- `tests/test_engine/test_checkpoint.py` - Unit tests
- `tests/test_integration/test_checkpoint_workflows.py` - Integration tests

### Modified Files
- `src/copilot_conductor/config/schema.py` - Add CheckpointConfig
- `src/copilot_conductor/engine/workflow.py` - Integrate checkpointing
- `src/copilot_conductor/cli/app.py` - Add checkpoint commands
- `src/copilot_conductor/cli/run.py` - Add resume option
